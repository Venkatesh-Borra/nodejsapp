    ...
    <main>
      ...
      <section v-if="page === 'home'" class="intro section">
        <div class="container two-col">
          ...
          <p class="lead">
            Vontimitta in YSR Kadapa district is best known for the historic
            Sri Kodandarama Swamy Temple. The temple is renowned for its
            sculptural richness, monumental gopurams and its distinctive
            tradition of worshipping Rama, Sita and Lakshmana together in a
            single-stone image.
          </p>
        </div>
      </section>
